...
prompts = {
    ...
    "LIFEFORM_PROMPT": "Your task is to take an input value between -1 and 1 and map it onto the following spectrum. The mapping between -1 (e.g. cyber, machine, inorganic, technology) and 1 (e.g. biological being, vegetation, plants, flora, fungi, algae) should be linear, with intermediate values describing entities on this spectrum. Return a maximum of three words. The input value is ",
