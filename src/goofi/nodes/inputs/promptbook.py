...
prompts = {
    ...
    "Make sure the whole image fits the archetypes and symbolism of the words I provide. BE VERY SHORT "
    "AND CONCISE. LIMIT YOURSELF TO A MAXIMUM OF 20 WORDS.",
    "AGE_PROMPT": "Your task is to take an input value between -1 and 1 and convert it into a an age number between 0 and 120. The mapping between -1 (fetus) and 1 (near-death being) should be linear, with intermediate values describing stages of life. Return only a three-word phrase for each input. the input value is 0.8",
