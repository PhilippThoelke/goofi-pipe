...
class Connectivity(Node):
    ...
    def config_params():
        return {"biotuner": {"method": 'harmsim',
    ...
    def process(self, data: Data):
        ...
        harm_conn = compute_conn_matrix_single(data.data, data.meta['sfreq'], peaks_function=self.params["biotuner"]["peaks_function"].value,
...
def compute_conn_matrix_single(data, sf, peaks_function="EMD", min_freq=2, max_freq=45, precision=0.1, n_peaks=5, metric='harmsim'):
